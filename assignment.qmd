---
title: "CS-201 Website Assignment (Fall 2025)"
toc: true
date: 10/20/25
---
...
This project counts as Homework Assignment #7. It will be due on **TBA**.

### How to Submit

There are two steps to submitting this project.

1.  Add your website to your GitHub profile.

![](media/update_profile.png){fig-align="left" width="40%"}

2.  Submit a "done!" message to Canvas that includes your website URL. It should look something like `<yourgithubname>.github.io`.
...
6.  Everything should be neat, free of typos, and reflect thought and planning.
