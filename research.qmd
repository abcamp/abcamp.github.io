...
I work in phonetics, phonology, and psycholinguistics. My research focuses on the mental representations of suprasegmentals, such as tone and intonation, and the cues listeners use to access these representations in spoken language processing. I investigate these subjects through implementing experiments, both in laboratory and field settings.
...
This project is in collaboration with [Catherine Brockway](https://geoling.github.io) and [Connor Flynn](https://connorflynn.github.io). A current working demo is available [here](https://github.com/abcamp/LanguageFinder_demo).
